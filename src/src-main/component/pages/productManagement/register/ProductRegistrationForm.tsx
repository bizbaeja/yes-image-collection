...
function ProductRegistrationForm({ title }: ProductRegistrationFormProps) {
  // 상태로 바이트 수를 관리
  const [byteCount, setByteCount] = useState(0);
  const maxBytes = 5 * 1024 * 1024; // 최대 5MB  const [content, setContent] = useState('<p>초기 콘텐츠입니다.</p>');
  const [items, setItems] = useState([{ item: "", info: "" }]);
  ...
  const [formData, setFormData] = useState<{
    ...
    returnExchangeMethod: string;
    returnExchangeTime: string;
    returnExchangeCost: string;
    returnExchangeNotAllowedReason: string;
    compensationForDamage: string;
    compensationForReturnDelay: string;
    ...
    aiBox: string[];
    origin: string;
    maxPurchasePerDay: string;
    maxPurchasePerID: string;
    isOnSale: string;
    salePrice: string;
    alternateSalePrice: string;
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const totalSize = (files as File[]).reduce((acc: number, file: File) => acc + file.size, 0);
    if (totalSize <= maxBytes) {
      setFormData({ ...formData, imageList: files as File[] });
      setByteCount(totalSize);
    } else {
      alert("업로드할 수 있는 총 파일 크기는 5MB를 초과할 수 없습니다.");
    }
  };
      ...
      <table className="table-auto w-full border-collapse">
        <tbody>
          ...
          <tr className="border">
            ...
            <td className="p-2">
              <input
                ...
                onChange={handleInputChange}
                className="border border-gray-300 rounded-md  focus:outline-none focus:border-blue-500 p-2 w-full"
              />
            </td>
          </tr>
          ...
          <tr className="border">
            ...
            <td className="p-2">
              <input type="text" name="origin" className="border border-gray-300 rounded-md p-2 focus:outline-none focus:border-blue-500"></input>
            </td>
          </tr>
          {/* 일일 최대 구매 갯수 */}
          <tr className="border">
            ...
            <td className="p-2">
              <input type="text" name="maxCountByDay" className="border border-gray-300 rounded-md p-2 focus:outline-none focus:border-blue-500"></input>
              <span>개</span>
            </td>
          </tr>
          {/* ID 당 구매 횟수 */}
          <tr className="border">
            ...
            <td className="p-2">
              <input type="text" name="maxCountByID" className="border border-gray-300 rounded-md p-2 focus:outline-none focus:border-blue-500"></input>
              <span>회</span>
            </td>
          </tr>
          {/* 판매기간사용 */}
          ...
          <tr className="border">
            ...
            <td className="p-2">
              <input type="text" name="purchasePrice" className="border border-gray-300 rounded-md p-2 focus:outline-none focus:border-blue-500"></input>
              <span>원</span>
            </td>
          </tr>
          {/* 소비자가 */}
          <tr className="border">
            ...
            <td className="p-2">
              <input type="text" name="consumerPrice" className="border border-gray-300 rounded-md p-2 focus:outline-none focus:border-blue-500"></input>
              <span>원</span>
            </td>
          </tr>
             {/* 할인율 */}
            ...
            <td className="p-2">
              <input type="text" name="discountRate" className="border border-gray-300 rounded-md p-2 focus:outline-none focus:border-blue-500"></input>
              <span>%</span>
            </td>
          </tr>
            ...
            <label htmlFor="shop">샵</label>
              <input type="text" name="shop" className="border border-gray-300 rounded-md p-2 focus:outline-none focus:border-blue-500"></input>
              
              <span>P</span><br/>
              <label htmlFor="welfare">복지</label>
              <input type="text" name="welfare" className="border border-gray-300 rounded-md p-2 focus:outline-none focus:border-blue-500"  ></input>
            
              <span>P</span><br></br>
              <label htmlFor="credit">여신</label>
              <input type="text" name="credit" className="border border-gray-300 rounded-md p-2 focus:outline-none focus:border-blue-500"  ></input>
  ...
  <td className="p-4" colSpan={5}>
    ...
    <table className="table-auto w-full mt-4 border-collapse">
      <thead className="bg-gray-100">
        <tr>
          ...
          <th className="border px-4 py-2 text-left">제주 추가비용</th>
          <th className="border px-4 py-2 text-left">도서산간 추가비용</th>
      ...
      <tbody>
        <tr>
          <td className="border px-4 py-2">
            <input type="text" className="border px-2 py-1 w-16" placeholder="개" />
            <span> ~ </span>
            <input type="text" className="border px-2 py-1 w-16" placeholder="개" />
          </td>
          <td className="border px-4 py-2">
            <input type="text" className="border px-2 py-1 w-24" placeholder="원" />
          </td>
          <td className="border px-4 py-2">
            <input type="text" className="border px-2 py-1 w-24" placeholder="원" />
          </td>
    ...
    <div className="mt-4">
      ...
      <label className="mr-4">
        <input type="radio" name="island_shipping" className="mr-2" /> 설정함
      </label>
      <label className="mr-4">
        <input type="radio" name="island_shipping" className="mr-2" /> 설정 안함
      </label>
      <label>
        <input type="radio" name="island_shipping" className="mr-2" /> 배송불가
      </label>
    </div>
  </td>
</tr>
          ...
          <tr className="border">
            ...
            <td className="p-2">
              ...
              <p className="text-sm text-gray-500">
                최대 5MB 이하의 JPG, PNG, GIF 파일을 업로드할 수 있습니다.
              </p>
              <p className="text-sm text-gray-700">
                현재 총 파일 크기: {(byteCount / (1024 * 1024)).toFixed(2)} MB
              </p>
            </td>
          </tr>
      ...
      <tr>
            <td colSpan={2}>
              <h2 className="text-lg font-bold mt-4 mb-2">태그 관리</h2>
            </td>
      </tr>
